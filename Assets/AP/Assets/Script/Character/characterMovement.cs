...
public class characterMovement : MonoBehaviour {
   ...
   //float mouseInputY = 0;
    ...
    public float jumpForce = 8; // Increase the jump force for a higher jump
    public float jumpSpeed = 5; // Adjust the jump speed for a smoother jump
    ...
    public float minimumJump = .6f; // Adjust the minimum jump duration for better control
